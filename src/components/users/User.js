      ...
      <section className="section">
        <div className="container">
          <div className="columns">
            ...
            <div className="column">
              ...
              <div className="box">
                <h1 className="need-space"><strong>Contacts:</strong></h1>
                <div className="columns">
              ...
              <div className="box">
                <h1 className="need-space"><strong>Main Information:</strong></h1>
                <div className="columns">
                  <div className="is-user-info">
                    <h2>Country:</h2>
                    <h2>City:</h2>
        ...
        <div className="container">
          <div className="columns">
            <div className="column is-4">
              <div className="box">
                <h1 className="need-space"><strong>Favority Food:</strong></h1>
                {this.state.user.favfood.map(food =>
                  <span key={food}
                    className={`is-tag tag is-${food.split(' ')[0].toLowerCase()}`}
                  >{food}</span>
                )}
              </div>
            </div>
            ...
            <div className="column">
              <div className="box">
                <h1 className="need-space"><strong>Biography:</strong></h1>
                <h2 className="need-small-space">About me:</h2>
          ...
          <div className="columns">
            ...
            <div className="column is-center-text ">
              ...
              <div className="box">
                <h1 className="need-space"><strong>Achievements:</strong></h1><br />
